...
const buttonStyle = {
  ...
  primary: {
    ...
    boxShadow:
      '0 2px 2px 0 rgba(33, 150, 243, 0.14), 0 3px 1px -2px rgba(33, 150, 243, 0.2), 0 1px 5px 0 rgba(33, 150, 243, 0.12)',
    '&:hover,&:focus': {
      backgroundColor: primaryColor,
      boxShadow:
        '0 14px 26px -12px rgba(33, 150, 243, 0.42), 0 4px 23px 0px rgba(33, 150, 243, 0.22), 0 8px 10px -5px rgba(33, 150, 243, 0.3)'
    }
  },
  info: {
